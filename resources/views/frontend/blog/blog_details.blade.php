...
<div class="body-content">
	...
	<h1>@if(session()->get('language') == 'filipino') {{ $blogpost->post_title_fil }} @else {{ $blogpost->post_title_en }} @endif</h1>
	...
	<p> @if(session()->get('language') == 'filipino') {!!  $blogpost->post_details_fil  !!} @else {!!  $blogpost->post_details_en  !!} @endif
	</p>
