      ...
      <div class="row product-micro-row">
        ...
        <div class="col col-xs-7">
          <div class="product-info">
            <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}">@if(session()->get('language') == 'filipino') {{ $product->product_name_fil }} @else {{ $product->product_name_en }} @endif</a></h3>
            <div class="rating rateit-small"></div>
 <div class="product-price"> <span class="price"> ₱ {{ $product->selling_price }}.00 </span> </div>
            <!-- /.product-price --> 
    ...
    <div class="product-price"> <span class="price"> ₱ {{ $product->selling_price }}.00 </span>  </div>
         @else
 <div class="product-price"> <span class="price"> ₱ {{ $product->discount_price }}.00 </span> <span class="price-before-discount">₱ {{ $product->selling_price }}.00</span> </div>
         @endif
                            <!-- /.product-price --> 
...
@if(session()->get('language') == 'filipino') {{ $skip_category_0->category_name_fil }} @else {{ $skip_category_0->category_name_en }} @endif
            </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
...
@if(session()->get('language') == 'filipino') {{ $product->product_name_fil }} @else {{ $product->product_name_en }} @endif
 ...
 <div class="product-price"> <span class="price"> ${{ $product->discount_price }} </span> <span class="price-before-discount">$ {{ $product->selling_price }}</span> </div>
        ...
        <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
@if(session()->get('language') == 'filipino') {{ $skip_category_1->category_name_fil }} @else {{ $skip_category_1->category_name_en }} @endif
            </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
...
@if(session()->get('language') == 'filipino') {{ $product->product_name_fil }} @else {{ $product->product_name_en }} @endif
 ...
 <div class="product-price"> <span class="price"> ${{ $product->discount_price }} </span> <span class="price-before-discount">$ {{ $product->selling_price }}</span> </div>
        ...
        <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
@if(session()->get('language') == 'filipino') {{ $skip_brand_1->brand_name_fil }} @else {{ $skip_brand_1->brand_name_en }} @endif
            </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                ...
                <div class="item">
                  <div class="blog-post">
                    ...
                    <div class="blog-post-info text-left">
                      <h3 class="name"><a href="#">@if(session()->get('language') == 'filipino') {{ $blog->post_title_fil }} @else {{ $blog->post_title_en }} @endif</a></h3>
  
  
                      <span class="info">{{ Carbon\Carbon::parse($blog->created_at)->diffForHumans()  }}</span>
  
                      <p class="text">@if(session()->get('language') == 'filipino') {!! Str::limit($blog->post_details_fil, 100 )  !!} @else {!! Str::limit($blog->post_details_en, 100 )  !!} @endif</p>
