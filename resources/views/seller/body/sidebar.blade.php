                ...
                <div class="h-100 border-end mb-2">
                  <div class="d-lg-block collapse" id="account-menu">
                    ...
                    <ul class="list-unstyled mb-0">
                      <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 {{ (request()->is('vendor/dashboard')) ? 'active' : '' }}" href="{{ route('vendor.dashboard') }}"><i class="ci-money-bag opacity-60 me-2"></i>Sales</a></li>
                      <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 {{ (request()->is('vendor/all/product')) ? 'active' : '' }}" href="{{ route('vendor.all.product') }}"><i class="ci-package opacity-60 me-2"></i>Products<span class="fs-sm text-muted ms-auto">{{ $productCount }}</span></a></li>
                      <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 {{ (request()->is('vendor/add/product')) ? 'active' : '' }}" href="{{ route('vendor.add.product') }}"><i class="ci-cloud-upload opacity-60 me-2"></i>Add New Product</a></li>
                      <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 {{ (request()->is('vendor/order')) ? 'active' : '' }}" href="{{ route('vendor.order') }}"><i class="ci-currency-exchange opacity-60 me-2"></i>Customer Orders</a></li>
                      <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 {{ (request()->is('vendor/return/order')) ? 'active' : '' }}" href="{{ route('vendor.return.order') }}"><i class="ci-arrows-horizontal opacity-60 me-2"></i>Returning Orders</a></li>
                      <li class="mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 {{ (request()->is('vendor/complete/return/order')) ? 'active' : '' }}" href="{{ route('vendor.complete.return.order') }}"><i class="ci-reply opacity-60 me-2"></i>Returned Orders</a></li>
