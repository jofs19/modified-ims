    ...
    <div class="container pt-2 pb-3">
      <div class="row">
        <div class="col-md-6 text-center text-md-start mb-4">
          <div class="text-nowrap mb-3"><a class="d-inline-block align-middle mt-n1 me-2" href="#"><img class="d-block" src="{{ asset('frontendv2/assets/img/logo5.svg') }}" width="117" alt="vartouhi"></a><span class="d-inline-block align-middle h5 fw-light text-white mb-0">Marketplace</span></div>
