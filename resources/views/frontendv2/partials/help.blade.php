...
@section('title')
Vartouhi | Help Center
@endsection


      <!-- Hero section with search-->
      <section class="position-relative bg-dark bg-size-cover bg-position-center-x position-relative py-5 mb-5" style="background-image: url({{ asset('frontendv2/assets/img/pages/help-hero-bg.jpg') }});"><span class="position-absolute top-0 start-0 w-100 h-100 bg-darker" style="opacity: .65;"></span>
          ...
          <div class="col-lg-4 col-sm-6 mb-grid-gutter">
            <div class="card border-0 shadow">
              <div class="card-body text-center"><i class="ci-user-circle h2 mt-2 mb-4 text-primary"></i>
                ...
                <p class="fs-sm text-muted pb-2">Proin nec turpis vel tortor venenatis tempus. Sed mollis vel arcu in tempor. Mauris enim purus, laoreet nec elit non euismod tempur accusantium.</p><a class="btn btn-outline-primary btn-sm stretched-link mb-2" href="help-single-topic.html">Learn more</a>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-sm-6 mb-grid-gutter">
      ...
      <section class="container text-center pt-1 pb-5 mb-2">
        <h2 class="h4 pb-3">Haven't found the answer? We can help.</h2><i class="ci-help h3 text-primary d-block mb-4"></i><a class="btn btn-info me-3" href="help-submit-request.html">Customer support</a><a class="btn btn-accent" href="help-submit-request.html">Technical Support</a>
