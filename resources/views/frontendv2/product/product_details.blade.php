...
@section('title')
{{ $product->product_name_en }} Item Details
@endsection
      ...
      <div class="container">
        <div class="bg-light shadow-lg rounded-3">
          ...
          <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item"><a class="nav-link py-4 px-sm-4 active" href="#general" data-bs-toggle="tab" role="tab">Item <span class='d-none d-sm-inline'>Info</span></a></li>
            <li class="nav-item"><a class="nav-link py-4 px-sm-4" href="#specs" data-bs-toggle="tab" role="tab"><span class='d-none d-sm-inline'>Staff</span> Info</a></li>
                  ...
                  <div class="col-lg-7 pe-lg-0">
                    <div class="product-gallery">
                      ...
                      <div class="product-gallery-preview order-sm-2">
                        ...
                        @if($loop->first)
                        <div class="product-gallery-preview-item active" id="slide{{ $img->id }}"><img class="image-zoom" src="{{ asset($img->photo_name ) }}" data-zoom="{{ asset($img->photo_name ) }}" alt="Item image">
                            <div class="image-zoom-pane"></div>
                          </div>
                        @else
                        <div class="product-gallery-preview-item" id="slide{{ $img->id }}"><img class="image-zoom" src="{{ asset($img->photo_name ) }}" data-zoom="{{ asset($img->photo_name ) }}" alt="Item image">
                            <div class="image-zoom-pane"></div>
                          </div>
                        @endif
                      ...
                      <div class="product-gallery-thumblist order-sm-1">
                        ...
                        <a class="product-gallery-thumblist-item active" href="#slide{{ $img->id }}"><img src="{{ asset($img->photo_name ) }}" alt="Item thumb"></a>

                        @else

                        <a class="product-gallery-thumblist-item" href="#slide{{ $img->id }}"><img src="{{ asset($img->photo_name ) }}" alt="Item thumb"></a>
...
<br>
                      ...
                      <div class="position-relative me-n4 mb-3">
                        ...
                        @else
                        <div class="product-badge product-available mt-n1"><i class="ci-security-check"></i>Item available</div>
                      ...
                      <div class="mb-3">
                        <label for="color" class="form-label">Item Options:</label>
...
<div class="form-check form-option form-check-inline mb-2">
  ...
  <label for="m" class="form-option-label">150 ML</label>
                      ...
                      <div class="d-flex align-items-center pt-2 pb-4">
                        ...
                        <button class="btn btn-secondary btn-shadow d-block w-100" disabled type="button"><i class="ci-cart fs-lg me-2"></i>Request Item</button>
                        @else
           ...
           <input type="hidden" id="vproduct_id" value="{{ $product->vendor_id }}">
			    ...
			    <button type="submit" id="try" onclick="addToCartDetails()" class="btn btn-primary btn-shadow d-block w-100 shimmer-btn placeholder-wave" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to Cart"><i class="ci-cart fs-lg me-2"></i> Request Item</button>
                      ...
                      <div class="d-flex mb-4">
                        <div class="w-100 me-3">
                          <button class="btn btn-warning btn-shadow d-block w-100" type="button" data-bs-toggle="tooltip" id="{{ $product->id }}" data-bs-placement="bottom" onclick="addToWishList(this.id)" title="Add to Wishlist"><i class="ci-star fs-lg me-2"></i><span class='d-none d-sm-inline'>Add to </span>Favorites</button>
                        </div>
                        {{-- <div class="w-100">
                          ...
                          <div class="accordion-collapse collapse show" id="shippingOptions" data-bs-parent="#productPanels">
                            <div class="accordion-body fs-sm">
                              <div class="d-flex justify-content-between border-bottom pb-2">
                                <div>
                                  <div class="fw-semibold text-dark">Item Brand</div>
                              ...
                              <div class="d-flex justify-content-between pt-2">
                                <div>
                                  <div class="fw-semibold text-dark">Staff</div>
                            ...
                            <div class="tab-pane fade" id="specs" role="tabpanel">
                                <div class="d-md-flex justify-content-between align-items-start pb-4 mb-4 border-bottom">
                                  <div class="d-flex align-items-center me-md-3">
                                    {{-- <img src="{{ (!empty($product->vendor->profile_photo_path)) ? url($product->vendor->profile_photo_path):url('upload/no_image.jpg') }}" width="120" alt="Item thumb"> --}}
                                    <div class="ps-3">
              ...
              {{-- <div class="tab-pane fade" id="reviews" role="tabpanel">
                <div class="d-md-flex justify-content-between align-items-start pb-4 mb-4 border-bottom">
                  <div class="d-flex align-items-center me-md-3"><img src="{{ asset($product->product_thumbnail) }}" width="90" alt="Item thumb">
                    <div class="ps-3">
          ...
          <div class="tns-carousel-inner" data-carousel-options="{&quot;items&quot;: 2, &quot;controls&quot;: true, &quot;nav&quot;: false, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:1},&quot;500&quot;:{&quot;items&quot;:2, &quot;gutter&quot;: 18},&quot;768&quot;:{&quot;items&quot;:3, &quot;gutter&quot;: 20}, &quot;1100&quot;:{&quot;items&quot;:4, &quot;gutter&quot;: 30}}}">
            ...
            <div>
              <div class="card product-card card-static slide-in-bck-center">
                ...
                <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i class="ci-heart"></i></button><a class="card-img-top d-block overflow-hidden" href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}"><img src="{{ asset($product->product_thumbnail) }}" alt="Item"></a>
