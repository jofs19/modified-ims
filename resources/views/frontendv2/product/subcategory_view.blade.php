      ...
      <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
            ...
            <li class="breadcrumb-item text-nowrap text-light">
                @if(Session::get('language') == 'filipino')
                {{$item->category->category_name_fil}}
                @else
            ...
            <li class="breadcrumb-item text-nowrap active" aria-current="page">Sub Category</li> --}}
          </ol>
        </nav>
      </div>
      <div class="order-lg-1 pe-lg-4 text-center text-lg-start">
        <h1 class="h3 text-light mb-0">Sub Category Products</h1>
      </div>
    </div>
  </div>
