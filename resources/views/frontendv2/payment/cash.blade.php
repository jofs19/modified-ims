    ...
    <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
          ...
          <li class="breadcrumb-item text-nowrap active" aria-current="page">Complete Request</li>
        </ol>
      </nav>
    </div>
    <div class="order-lg-1 pe-lg-4 text-center text-lg-start">
      <h1 class="h3 text-light mb-0">Complete Request</h1>
    </div>
  </div>
</div>
  ...
  <div class="row">
    <section class="col-lg-12">
      ...
      <div class="steps steps-light pt-2 pb-3 mb-5"><a class="step-item active" href="shop-cart.html">
          ...
          <div class="step-label"><i class="ci-cart"></i>Request</div></a><a class="step-item active" href="checkout-details.html">
      ...
      <!-- Order details-->
      <h2 class="h6 pt-1 pb-3 mb-3 border-bottom">Review your request</h2>
      ...
      <div class="bg-secondary rounded-3 px-4 pt-4 pb-2">
        <div class="row">
          <div class="col-sm-6">
            <h4 class="h6">Requestor Details:</h4>
            <ul class="list-unstyled fs-sm">

              <li><span class="text-muted">Requestor:&nbsp;</span>{{ Auth::user()->name }}</li>
          ...
          <div class="col-sm-6">
            ...
            <h4 class="h6">Contact & Address:</h4>
            <ul class="list-unstyled fs-sm">
              <li><span class="text-muted">Address:&nbsp;</span>{{ $data['shipping_address'] }}</li>
      ...
      <div class="d-none d-lg-flex pt-4">
        ...
        <div class="w-100 ps-2"><button class="btn btn-primary d-block w-100" type="submit"><span class="d-none d-sm-inline">Complete Request</span><span class="d-inline d-sm-none">Complete</span><i class="ci-arrow-right mt-sm-0 ms-1"></i></button></div>
      </div>
    </section>
    <!-- Sidebar-->
