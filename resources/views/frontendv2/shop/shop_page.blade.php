...
<div class="page-title-overlap bg-dark pt-4">
    <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
      <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
            ...
            <li class="breadcrumb-item text-nowrap"><a href="{{ route('shop.page') }}">Items</a>
            </li>
      ...
      <div class="order-lg-1 pe-lg-4 text-center text-lg-start">
        <h1 class="h3 text-light mb-0">Items Page</h1>
      </div>
    </div>
  </div>
        ...
        <div class="d-flex justify-content-center justify-content-sm-between align-items-center pt-2 pb-4 pb-sm-5">
          <div class="d-flex flex-wrap">
            <div class="d-flex align-items-center flex-nowrap me-3 me-sm-4 pb-3">
              ...
              <span class="fs-sm text-light opacity-75 text-nowrap ms-2 d-none d-md-block">of {{ $product_count }} items</span>
            </div>
          </div>
        ...
        <div class="row mx-n2">
          ...
          <div class="col-md-4 col-sm-6 px-2 mb-4">
            <div class="card product-card product-section">
              ...
              <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to favorites" id="{{ $product->id }}" onclick="addToWishList(this.id)"><i class="ci-star"></i></button><a class="card-img-top d-block overflow-hidden" href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}"><img src="{{ asset($product->product_thumbnail) }}" alt="Product"></a>
              ...
              <div class="card-body card-body-hidden">
                ...
                onclick="productView(this.id)"><i class="ci-bag fs-sm me-1"></i>Request Item</a> --}}
