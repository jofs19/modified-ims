    ...
    <div class="bg-white rounded-3 shadow-lg pt-1 mb-5 mb-lg-0">
      ...
      <div class="d-lg-block collapse" id="account-menu">
        ...
        {{-- <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 {{ (request()->is('dashboard')) ? 'active' : '' }}" href="{{ route('dashboard') }}"><i class="ci-view-grid opacity-60 me-2"></i>Dashboard</a></li> --}}
          ...
          <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 {{ (request()->is('user/my/orders')) ? 'active' : '' }}" href="{{ route('my.orders') }}"><i class="ci-bag opacity-60 me-2"></i>Requests<span class="fs-sm text-muted ms-auto"> <span class="badge rounded-pill bg-info ">{{ count($order) }}</span>
            </span></a></li>
          <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 {{ (request()->is('user/wishlist')) ? 'active' : '' }}" href="{{ route('wishlist') }}"><i class="ci-star opacity-60 me-2"></i>Favorites<span class="fs-sm text-muted ms-auto">
          ...
          <li class="mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 {{ (request()->is('user/return/order/list')) ? 'active' : '' }}" href="{{ route('return.order.list') }}"><i class="ci-reply opacity-60 me-2"></i>Returned Requests<span class="fs-sm text-muted ms-auto"><span class="badge rounded-pill bg-accent ">{{ count($returned) }}</span></span></a></li>
          ...
          <li class="mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 {{ (request()->is('user/cancel/orders/list')) ? 'active' : '' }}" href="{{ route('cancel.orders.list') }}"><i class="ci-trash
            opacity-60 me-2"></i>Cancelled Requests<span class="fs-sm text-muted ms-auto"><span class="badge rounded-pill bg-warning ">{{ count($cancelledOrders_count) }}</span></span></a></li>
