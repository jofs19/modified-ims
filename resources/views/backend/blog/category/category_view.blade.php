  ...
  <!-- Content Wrapper. Contains page content -->
			...
			<div class="col-8">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">Blog Category List <sup> <span class="badge badge-pill badge-danger"> {{ count($blogcategory) }} </span></sup></h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
	 ...
	 <tr>
		...
		<td>{{ $item->blog_category_name_en }}</td>
		 <td>{{ $item->blog_category_name_fil }}</td>
		<td>
...
<!--   ------------ Add Blog Category Page -------- -->
 ...
 <form method="post" action="{{ route('blogcategory.store') }}" >
	...
	<div class="form-group">
		...
		<div class="controls">
	 <input type="text" name="blog_category_name_fil" class="form-control" >
