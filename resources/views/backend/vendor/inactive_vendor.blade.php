			...
			<div class="col-12">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">Unauthorized Vendors <sup><span class="badge badge-pill badge-danger"> {{$Inactivecount }} </span></sup></h3>
					  ...
					  <table id="example1" class="table table-bordered table-striped text-center">
						...
						<tbody>
                            ...
                            <tr>
                                ...
                                <td> <span class="btn btn-primary">Unauthorize</span></td>

                                <td><a href="{{ route('inactive.vendor.details',$item->id) }}" class="btn btn-info" title="View Data"><i class="fa fa-eye"></i> </a></td>
