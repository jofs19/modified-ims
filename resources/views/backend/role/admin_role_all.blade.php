  ...
  <!-- Content Wrapper. Contains page content -->
	 ...
	 <tr>
        ...
        {{-- <td>
			...
			<span class="badge btn-dark">Admin Users role</span>
			@else
			@endif
		...
		<td width="25%">
 <a href="{{ route('edit.admin.user',$item->id) }}" class="btn btn-info" title="Edit Admin"><i class="fa fa-pencil"></i> </a>

 <a target="_blank" href="{{ route('delete.admin.user',$item->id) }}" class="btn btn-danger" title="Delete Admin" id="delete">
