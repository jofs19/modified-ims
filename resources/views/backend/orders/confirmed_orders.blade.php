...
@section('admin')
  ...
  <!-- Content Wrapper. Contains page content -->
			...
			<div class="col-12">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">Confirmed Items List</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
	 ...
	 <tr>
		...
		<td> <span class="badge badge-pill badge-success">{{ $item->status }}ed </span>  </td>

		<td width="25%">
 <a href="{{ route('pending.order.details',$item->id) }}" class="btn btn-info" title="Edit Data"><i class="fa fa-eye"></i> </a>
 <a href="{{ route('confirm.processing',$item->id) }}" class="btn btn-success fa fa-check" id="processing"></a>
