                                ...
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <h5>Item Quantity <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    value="{{ $products->product_tags_en }}" data-role="tagsinput" required="" >
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    value="{{ $products->product_tags_fil }}" data-role="tagsinput" required="">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    value="{{ $products->product_color_fil }}" data-role="tagsinput">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    value="{{ $products->product_size_fil }}" data-role="tagsinput">
...
{{--
		...
		{!! $products->short_descp_en !!}
                                        ...
                                        {{-- <div class="col-md-6">
                                            <div class="form-group">
                                                <h5>Short Description (Fil) <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                                    <textarea name="short_descp_fil" id="textarea" class="form-control"
                                                        required placeholder="Textarea text">
		{!! $products->short_descp_fil !!}
	</textarea>
                                                </div>
                                            </div>
		...
		{!! $products->long_descp_en !!}
                                        ...
                                        {{-- <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea id="editor2" name="long_descp_fil" rows="10" cols="80">
		{!! $products->long_descp_fil !!}
						</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <fieldset>
                                                        ...
                                                        <label for="checkbox_2">Best Seller</label>
                                                    </fieldset>
                                                    <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <label for="checkbox_5">Trending Products</label>
                                                    </fieldset>
                                                </div>
            ...
            <div class="col-md-12">
                <div class="box bt-3 border-info">
                    <div class="box-header">
                        <h4 class="box-title">Item Multiple Image <strong>Update</strong></h4>
                    </div>
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box bt-3 border-info">
                    <div class="box-header">
                        <h4 class="box-title">Item Thumbnail Image <strong>Update</strong></h4>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('select[name="category_id"]').on('change', function () {
            ...
            if (category_id) {
                $.ajax({
                    url: "{{ url('/category/subcategory/ajax') }}/" +
                        category_id,
                    type: "GET",
                    dataType: "json",
